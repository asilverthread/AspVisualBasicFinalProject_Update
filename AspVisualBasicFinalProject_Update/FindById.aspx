<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="FindById.aspx.vb" Inherits="AspVisualBasicFinalProject_Update.FindById" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server"> 
    <br>
    ID:<asp:TextBox ID="txtID" runat="server" Width="31px"></asp:TextBox>
